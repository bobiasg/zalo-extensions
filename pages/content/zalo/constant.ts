export const FRIEND_LIST_ELEM_ID = 'conversationListId';
export const APP_CONTAINER = 'app-page';
export const FIND_FRIEND_CONTAINER = 'findFriend';
export const FIND_FRIEND_PHONE_NUMBER_INPUT = '[data-id="txt_Main_AddFrd_Phone"]';
export const ADD_FRIEND_BTN_SELECTOR = '[data-id="btn_Main_AddFrd"]';
export const PROFILE_CONTAINER_SELECTOR = 'div.pi-info-layout';
export const ADD_NEW_FRIEND_BTN_SELECTOR =
  PROFILE_CONTAINER_SELECTOR + ' div.pi-primary-action-section div.btn-neutral';
